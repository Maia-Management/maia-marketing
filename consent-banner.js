...
(function (window, document) {
  ...
  function injectStyles() {
    var css = '#maia-consent-overlay{position:fixed;top:0;left:0;width:100%;height:100%;overflow:hidden;background:rgba(27,42,74,0.55);z-index:2147483646;display:flex;align-items:flex-end;justify-content:center;font-family:Inter,Montserrat,Arial,sans-serif}' +
  ...
  function injectHTML() {
    ...
    var logo = document.createElement('div'); logo.className = 'mcb-logo'; logo.innerHTML = 'MAIA MANAGEMENT S.A.S.<br>NIT 901.862.977-7';
    ...
    footerNote.innerHTML = 'MAIA MANAGEMENT S.A.S. \u2014 NIT 901.862.977-7 \u2014 Calle 24 #3-99, Edificio Banco de Bogot\u00e1, Suite 1102, Level 11, Santa Marta, Magdalena, Colombia. Puedes cambiar tus preferencias en cualquier momento desde el pie de p\u00e1gina.';
